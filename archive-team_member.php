...
<div id="team-members-archive" class="section" style="padding-top:40px;">
    <div class="container">
        <div class="row s-padding">
            <main id="main" class="col-md-12">
                <div class="archive-header text-center">
                    <h1 class="archive-title"><?php _e('All Team Members', 'edelweiss-gaishofen'); ?></h1>
                    <p class="archive-description"><?php _e('Meet our team members and learn more about each person and team.', 'edelweiss-gaishofen'); ?></p>
                </div>

                <?php
                // Get all team categories for filtering
                ...
                ?>
                    <div class="team-filter text-center">
                        <h3><?php _e('Filter by Category', 'edelweiss-gaishofen'); ?></h3>
                        <div class="filter-buttons">
                            <a href="<?php echo get_post_type_archive_link('team_member'); ?>" class="filter-btn <?php echo !is_tax('team_category') ? 'active' : ''; ?>">
                                <?php _e('All', 'edelweiss-gaishofen'); ?>
                            </a>
                            <?php foreach ($team_categories as $category) : ?>
                                <a href="<?php echo get_term_link($category); ?>" class="filter-btn <?php echo is_tax('team_category', $category->term_id) ? 'active' : ''; ?>">
                                            ...
                                            ?>
                                                <div class="team-categories">
                                                    <?php foreach ($terms as $term) : ?>
                                                        <a href="<?php echo get_term_link($term); ?>" class="category-tag">
                ...
                <?php else : ?>
                    <div class="no-team-members text-center">
                        <h3><?php _e('No team members found', 'edelweiss-gaishofen'); ?></h3>
                        <p><?php _e('There are currently no team members to display.', 'edelweiss-gaishofen'); ?></p>
                ...
                <div class="back-to-home text-center">
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="white-btn">
