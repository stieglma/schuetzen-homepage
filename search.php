            ...
            <main id="main" class="col-md-8 col-md-offset-2">
                <div class="search-header">
                    <h1 class="search-title">
                        <?php
                        printf(
                            esc_html__('Search Results for: %s', 'edelweiss-gaishofen'),
                    ...
                    <div class="blog-box">
                        <div class="blog">
                            <div class="blog-content">
                                ...
                                <p><?php _e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'edelweiss-gaishofen'); ?></p>
                                <?php get_search_form(); ?>
                            </div>
                        </div>
                    </div>
